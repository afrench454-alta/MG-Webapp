...
- Name: demo-console.spec.ts >> FieldCentral Pro Console - Demo Mode >> navigates to Clients directory and filters records
- Location: tests\e2e\demo-console.spec.ts:17:7
