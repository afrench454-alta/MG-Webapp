...
- Name: demo-console.spec.ts >> FieldCentral Pro Console - Demo Mode >> navigates to Job Board kanban
- Location: tests\e2e\demo-console.spec.ts:53:7
...
Call log:
  - waiting for getByRole('button', { name: 'Job Board' })
