...
- Name: demo-console.spec.ts >> FieldCentral Pro Console - Demo Mode >> navigates to Schedule calendar and daily agenda
- Location: tests\e2e\demo-console.spec.ts:44:7
...
Call log:
  - waiting for getByRole('button', { name: 'Schedule' })
